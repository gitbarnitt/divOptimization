...
# Usage: .\rebuild_and_deploy.ps1 [-ProjectId "neon-nonprod-common-services"] [-Region "us-central1"] [-Sites @("JERC")]
#
# This script:
...
Write-Host "Rebuild and Deploy: $ServiceName" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Step 2/3: Pushing to GCP Container Registry..." -ForegroundColor Yellow
Write-Host "----------------------------------------"
...
Write-Host "Image pushed to $ImageName" -ForegroundColor Green

# Step 3: Deploy
Write-Host ""
Write-Host "Step 3/3: Deploying..." -ForegroundColor Yellow
Write-Host "----------------------------------------"
...
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Rebuild and deployment complete" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
